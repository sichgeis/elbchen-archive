...
<template>
  <section id="impressum" class="max-w-[75%] mx-auto py-6 sm:py-16">
    <h2 class="text-lg md:text-xl text-center mb-6">Impressum</h2>
    <p>
      Geisler Software Consulting<br />
      Dr. Christian Geisler<br />
      Goethe-Allee 5<br />
      37073 G&#246;ttingen<br />
      Tel: +49 151 1624 5800<br />
      <a href="mailto:christian@masch-tech.de">christian@masch-tech.de</a>
    </p>
    <h2 class="text-lg md:text-xl text-center my-4">
      Disclaimer - rechtliche Hinweise
    </h2>
    <h3 class="text-lg md:text-l text-center my-2">
    ...
    <h3 class="text-lg md:text-l text-center my-2">Datenschutz (allgemein)</h3>
    <P
    ...
    <h3 class="text-lg md:text-l text-center my-2">3. Urheberrecht</h3>
    <p>
